...
def build_keras_rnn_decoder(
    ...
    caption_token_input = layers.Input(shape=(max_caption_len,), name="caption_token_input")

    # pre-inject: CNN feature diproyeksikan menjadi embedding token palsu di timestep awal
